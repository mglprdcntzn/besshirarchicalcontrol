...
def load_houses(nodes, Shouse, Strafo):
    ...
    nhouses = np.random.randint(nnominal*0.25, nnominal*0.95, N-1)
    ...
    for ii in range(N):
        ...
        for hh in range(houses[ii]):
            ...
            Aparatos = np.array([#P,fp,prob,Tmean
                    ...
                    [1500, 0.95, 3/7,4],#secador de pelo
            ...
            Aparatos = np.array([#P,fp,prob,Tmean
                    [7000, 0.95, 0.01/2, 2*60],#electric vehicle
                    [8, 0.80, 0.5,1*60],#celular
                    [150, 0.95, 0.25,2*60],#TV 1
                    [15*8, 0.999, 0.90,2*60],#Luces 1
                    [15*4, 0.999, 0.50,2*60],#Luces 2
                    [150, 0.90,0.75,2*60] #PC
                    ])
